...
const VALUES = [
  { icon: "🌍", title: "Built for everyone", desc: "We built SaucamPro for people everywhere — from first-time buyers to seasoned traders. Every product decision starts with the user, not the market." },
  { icon: "🔒", title: "Security first", desc: "We are fully licensed and regulated. Your assets are protected by bank-grade encryption, cold storage, and multi-factor authentication." },
  { icon: "⚡", title: "Speed and simplicity", desc: "Crypto should be as easy as online banking. We obsess over making complex financial infrastructure feel effortless." },
  { icon: "🤝", title: "Financial inclusion", desc: "We believe everyone deserves access to global financial markets. SaucamPro breaks down the barriers that have kept people out." },
    ...
    <InfoLayout>
      ...
      <section className="px-5 sm:px-10 pt-20 pb-16 bg-gradient-to-b from-gray-900 to-gray-800 text-center text-white">
        <motion.div initial="hidden" animate="visible" className="max-w-3xl mx-auto">
          ...
          <motion.h1 variants={fadeUp} custom={1} className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight mb-6">
            The world's home for<br className="hidden sm:block" /> digital assets
          </motion.h1>
          <motion.p variants={fadeUp} custom={2} className="text-gray-300 text-lg sm:text-xl leading-relaxed max-w-2xl mx-auto">
            SaucamPro is a licensed global digital asset trading platform. We are on a mission to make crypto accessible, safe, and useful for everyone, everywhere.
          </motion.p>
        </motion.div>
      </section>
      ...
      <section className="px-5 sm:px-10 py-16 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Democratising access to global crypto markets for everyone</h2>
            <p className="text-gray-500 leading-relaxed mb-4">
              We started SaucamPro because we believed the world deserved a better crypto trading experience — one built with real users in mind, not an afterthought of legacy finance.
            </p>
            <p className="text-gray-500 leading-relaxed">
              Today, we serve hundreds of thousands of users across the globe, offering a regulated, secure, and intuitive platform for buying, selling, and managing digital assets.
            </p>
          </div>
      ...
      <section className="px-5 sm:px-10 py-14 bg-white border-t border-gray-100">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-3 bg-gray-50 border border-gray-200 rounded-2xl px-6 py-4 shadow-sm mb-6">
            <span className="text-2xl">🛡️</span>
            <div className="text-left">
              <p className="font-bold text-gray-900 text-sm">Licensed Digital Asset Exchange</p>
              <p className="text-gray-400 text-xs">Regulated · Compliant · Audited</p>
            </div>
          </div>
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Regulated, compliant, and trustworthy</h2>
          <p className="text-gray-500 text-sm leading-relaxed max-w-xl mx-auto">
            SaucamPro is a fully licensed digital asset exchange operator. We comply with applicable regulations on virtual assets, AML/CFT, and customer data protection across every jurisdiction we operate in.
          </p>
        </div>
      </section>
      ...
      <section className="px-5 sm:px-10 py-20 text-center bg-gray-900">
        ...
        <p className="text-gray-400 mb-8 text-base max-w-md mx-auto">Start trading today and be part of one of the world's fastest-growing crypto platforms.</p>
